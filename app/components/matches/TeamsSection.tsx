...
export default function TeamsSection({ 
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="grid grid-cols-3 items-center gap-4 md:gap-3 sm:gap-4 w-full max-w-md md:max-w-sm">
                {/* Team 1 */}
                ...
                <div className="flex flex-col items-center justify-center space-y-1">
                    <span className="text-gray-500 font-semibold text-base md:text-sm">VS</span>

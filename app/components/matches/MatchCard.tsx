                    ...
                    {!areBothTeamsTBD && (match.status === 'running' || match.status === 'not_started') && (
                        <div className="flex items-center justify-center">
                            <button
                                ...
                                className="group flex items-center space-x-2 px-4 py-2.5 text-sm rounded-lg font-semibold transition-all duration-200 bg-indigo-500/20 hover:bg-indigo-500/25 text-indigo-300 hover:text-indigo-200 border border-indigo-500/30 hover:border-indigo-400/40 cursor-pointer min-w-[120px]"

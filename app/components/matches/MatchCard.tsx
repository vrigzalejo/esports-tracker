...
import { Calendar, Clock, Trophy, Users, Star, Globe, Crown, ExternalLink, Tv, Play, UserCheck, Zap } from 'lucide-react'
...
export default function MatchCard({ match }: MatchCardProps) {
    ...
    return (
        <>
            <div className="group bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 animate-slide-up shadow-lg hover:shadow-blue-500/10 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-[auto_auto_auto] items-center gap-4 sm:gap-6">
                        ...
                        <div className="flex flex-col items-center space-y-3">
                            ...
                            <div className="flex flex-col items-center space-y-1">
                                <span className={`font-bold text-center text-xs sm:text-sm ${finalWinner === 0 ? 'text-yellow-400' : 'text-white'}`}>
                                    {getTeamName(match.opponents[0] as Opponent)}
                                </span>
                                {(isMatchFinished || isMatchLive) && matchResults && (
                                    <span className={`text-lg sm:text-xl font-bold px-3 py-1 rounded-lg ${isMatchLive
                        ...
                        <div className="flex flex-col items-center space-y-3">
                            ...
                            <div className="flex flex-col items-center space-y-1">
                                <span className={`font-bold text-center text-xs sm:text-sm ${finalWinner === 1 ? 'text-yellow-400' : 'text-white'}`}>
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-6 mb-4">
                    ...
                    {!isPast && countdown && (
                        <div className={`flex items-center text-xs sm:text-sm px-3 py-1 rounded-full ${isLive

...
export default function MatchCard({ match }: MatchCardProps) {
    ...
    return (
        <>
            <div 
                className="group bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 cursor-pointer animate-slide-up shadow-lg hover:shadow-blue-500/10 relative overflow-hidden"
